const paintings = [
  {
    ...
    year: 1889,
    description:
      'Одна из самых известных картин Ван Гога, изображающая ночной вид из окна его приюта в Сен-Реми-де-Прованс.',
  ...
  },
  {
    ...
    year: 1898,
    description:
      'Самая известная картина Васнецова, изображающая трех былинных богатырей: Илью Муромца, Добрыню Никитича и Алешу Поповича.',
